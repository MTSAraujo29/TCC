...
function LoginPage() {
    ...
    const handleSuccessfulLogin = (data) => {
        ...
        // Decodificar o token para pegar o campo exp (expiração)
        try {
    ...
    return ( <
        ...
        <
        input type = { uiState.showPassword ? 'text' : 'password' }
        name = "password"
        placeholder = "Senha"
        ...
        title = { passwordToggleTitle } > { passwordToggleIcon } <
        /span> < /
        div >
        ...
        <
        button type = "submit"
        disabled = { uiState.loading } > { uiState.loading ? 'Entrando' : 'Entrar' } {
