                    ...
                    options = {
                        {
                            ...
                            plugins: {
                                ...
                                legend: { display: false }, // Remove legenda padrão
                                datalabels: { display: false }, // Remove labels internas se estiver usando plugin
                            },
                        }
                    }
                    /> { / * Legenda personalizada em duas linhas, agora menor * / } {
                    (() => {
