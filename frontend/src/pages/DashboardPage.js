...
{ /* ========== ECOBOT SECTION ========== */ } {
    activeSection === 'ecobot' && ( <
        ...
        <
        div style = {
            { width: '100%', maxWidth: 600, minWidth: 340, position: 'sticky', top: 0, background: 'transparent', zIndex: 2 }
        } >
        <
        h1 style = {
        ...
        div > <
        div style = {
            { background: '#23234a', borderRadius: 12, padding: 24, maxWidth: 600, width: '100%', minWidth: 320, margin: '0 auto', minHeight: 320, display: 'flex', flexDirection: 'column', gap: 12, flex: 1, overflow: 'auto' }
        } >
        <
        div style = {
