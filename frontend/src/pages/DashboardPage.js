            ...
            >
                ...
                >
                    <img
                        src="/icon.png"
                        alt="Ícone"
                        style={{ width: 64, height: 64, marginBottom: 16, marginTop: -48 }}
                    />
        ...
        <div className="container dashboard-container">
            ...
            {window.innerWidth <= 700 && (
                <div className="mobile-menu-bar">
                    <div className="smart-energy-title-mobile" style={{ flex: 1, justifyContent: 'center' }}>
                        <img src={icon} alt="Ícone Smart Energy" />
                        Smart Energy
                    </div>
                    <button
