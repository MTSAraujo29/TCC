                    ...
                    localStorage.getItem('isAdmin') === 'true' ? (
                        (() => {
                            ...
                            return ( <
                                ...
                                } > { total > 0 ? ((data.datasets[0].data[0] / total) * 100).toFixed(1) : '0.0' } % < /span> < /
                                span > <
                                span style = {
                                    { display: 'inline-flex', alignItems: 'center', gap: 4, whiteSpace: 'nowrap' }
                                } >
                                ...
                                span style = {
                                    { color: '#FFF', fontWeight: 700 }
                                } > { total > 0 ? ((data.datasets[0].data[1] / total) * 100).toFixed(1) : '0.0' } % < /span> < /
                                span > <
                                /span>
                            );
                        })()
                        ...
                        <
                        span style = {
                            { display: 'inline-block', width: 12, height: 12, borderRadius: 6, background: '#00bcd4', marginRight: 4 }
                        } > < /span> <
                        span style = {
                            { color: '#FFF', fontWeight: 500 }
                        } > TV: < /span> <
                        ...
                        <
                        span style = {
                            { display: 'inline-block', width: 12, height: 12, borderRadius: 6, background: '#ff9800', marginRight: 4 }
                        } > < /span> <
                        span style = {
                            { color: '#FFF', fontWeight: 500 }
                        } > Luz 1: < /span> <
                        ...
                        <
                        span style = {
                            { display: 'inline-block', width: 12, height: 12, borderRadius: 6, background: '#8bc34a', marginRight: 4 }
                        } > < /span> <
                        span style = {
                            { color: '#FFF', fontWeight: 500 }
                        } > Ar: < /span> <
                        ...
                        <
                        span style = {
                            { display: 'inline-block', width: 12, height: 12, borderRadius: 6, background: '#e91e63', marginRight: 4 }
                        } > < /span> <
                        span style = {
                            { color: '#FFF', fontWeight: 500 }
                        } > Luz 2: < /span> <
