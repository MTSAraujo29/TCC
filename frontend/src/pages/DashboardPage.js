                                ...
                                >
                                        ...
                                        <div style={{ display: 'flex', justifyContent: 'center', gap: 18 }}>
                                            <label className="custom-checkbox">
                                                <input
                                                    ...
                                                    onChange={() => handleDeviceSelect('sala')}
                                                />
                                                <span className="checkmark" /> Sonoff Sala
                                            </label>
                                            <label className="custom-checkbox">
                                                <input
                                                    type="checkbox"
                                                    checked={selectedDevices.includes('camera')}
                                                    onChange={() => handleDeviceSelect('camera')}
                                                />
                                                <span className="checkmark" /> Sonoff Câmera
                                            </label>
                                            <label className="custom-checkbox">
                                                <input
                                                    type="checkbox"
                                                ...
                                                />
                                                <span className="checkmark" /> Ambos
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ width: '100%', marginBottom: 8 }}>
                                        ...
                                        >
                                            <label className="custom-checkbox">
                                                ...
                                                />
                                                <span className="checkmark" /> Todos os dias
                                            </label>
                                            {weekDays.map((day, idx) => (
                                                <label key={day} className="custom-checkbox">
                                                    <input
                                                        ...
                                                        onChange={() => handleDaySelect(idx)}
                                                    />
                                                    <span className="checkmark" /> {day}
                                                </label>
                                            ))}
                                        </div>
                                    </div>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            />
                                            <span className="checkmark" /> Repetir nos dias selecionados
                                        </label>
                                    </div>
                        ...
                        <div className="tasmota-settings-card">
                            ...
                            {isRealData ? (
                                ...
                                <p className="admin-only-message">
                                    O gerenciamento completo de dispositivos está disponível apenas para
