    ...
    return ( <
        ...
        { /* ========== ENERGY CONTROL SECTION ========== */ } {
            ...
            div className = "menu-box-group" >
                <
                button type = "button"
            className = { `menu-box-option${selectedDevices.includes('sala') ? ' selected' : ''}` }
            onClick = {
                ...
                /button> <
            button type = "button"
            className = { `menu-box-option${selectedDevices.includes('camera') ? ' selected' : ''}` }
            onClick = {
                ...
                /button> <
            button type = "button"
            className = { `menu-box-option${selectedDevices.length === 2 ? ' selected' : ''}` }
            onClick = {
                    () => {
            ...
            onClick = { handleAllDaysSelect } >
                Todos os dias <
                /button> {
            weekDays.map((day, idx) => ( <
                button key = { day }
                type = "button"
                className = { `menu-box-option${selectedDays.includes(idx) ? ' selected' : ''}` }
                onClick = {
                    () => handleDaySelect(idx)
                } > { day } <
                /button>
