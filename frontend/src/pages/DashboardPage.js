    ...
    return (
        <>
            ...
            <div style={{
                ...
                <div className="logo-icon-sidebar" style={{ margin: 0, fontSize: '2.5rem' }}>⚡</div>
            </div>
            ...
            <div className="container dashboard-container" style={{ marginTop: '0' }}>
                    ...
                    <React.Fragment>
                        ...
                        <div className="metrics-grid">
                            <div className="metric-card">
                                ...
                                <p>
                                    {devices.length > 0 ?
                                        devices.reduce((sum, d) => sum + (d.latestReading && d.powerState && typeof d.latestReading.power === 'number' ? d.latestReading.power : 0), 0).toFixed(2) + ' W' :
                                        '0.00 W'
                                    }
                                </p>
                            </div>
                            ...
                            <div className="metric-card">
                                ...
                                <p>
                                    {devices.length > 0 ?
                                        devices.reduce((sum, d) => sum + (d.latestReading && d.powerState && typeof d.latestReading.totalEnergy === 'number' ? d.latestReading.totalEnergy : 0), 0).toFixed(2) + ' kWh' :
                                        '0.00 kWh'
                                    }
                                </p>
                            </div>
                            <div className="metric-card">
                                ...
                                <p>
                                    R$ {
                                    (devices.length > 0 ?
                                            devices.reduce((sum, d) => sum + (d.latestReading && d.powerState && typeof d.latestReading.totalEnergy === 'number' ? d.latestReading.totalEnergy : 0), 0) * 0.75 :
                                            0
                                    ).toFixed(2)
                                }
                                </p>
