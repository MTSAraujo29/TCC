                        ...
                        <div className="metrics-grid">
                            ...
                            <div className="metric-card">
                                ...
                                <p>
                                    {(
                                        devices
                                            .filter(d => d.powerState && d.latestReading && typeof d.latestReading.totalEnergy === 'number')
                                            .reduce((sum, d) => sum + d.latestReading.totalEnergy, 0)
                                    ).toFixed(2) + ' kWh'}
                                </p>
                            </div>
                                ...
                                <p>
                                    ...
                                    {(devices.length > 0 ?
                                            devices.reduce((sum, d) => sum + (d.latestReading && d.powerState && typeof d.latestReading.totalEnergy === 'number' ?
                                                d.latestReading.totalEnergy : 0), 0) * 0.75 :
                                            0
                                    ).toFixed(2)}
                                </p>
                            </div>
