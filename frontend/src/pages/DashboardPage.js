    ...
    return ( <
        ...
        { /* ========== ENERGY CONTROL SECTION ========== */ } {
            ...
            onSubmit = { handleScheduleSubmit } > { /* Seleção de Dispositivo */ } <
                label style = {
                    { color: '#FFF', fontWeight: 500, marginBottom: 4 }
                } > Dispositivo: < /label> <
            div style = {
            ...
            style = {
                { width: 120, marginBottom: 12 }
            }
            required / > { /* Botão */ } <
                button type = "submit"
            style = {
                    { marginTop: 12, background: '#00bcd4', color: '#FFF', border: 'none', borderRadius: 6, padding: '10px 0', fontWeight: 'bold', fontSize: 16, cursor: 'pointer' }
                } >
                Agendar <
                /button> {
            scheduleMessage && < p style = {
                { color: scheduleMessageColor, marginTop: 8 }
            } > { scheduleMessage } < /p>} < /
            form > <
                /div>
