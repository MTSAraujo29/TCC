            ...
            activeSection === 'inicio' && ( <
                ...
                { /* Gráfico de Pizza para não-admin */ } {
                    localStorage.getItem('isAdmin') !== 'true' && ( <
                        div style = {
                            { maxWidth: 400, margin: '0 auto 2rem auto', background: '#23243a', borderRadius: 16, padding: 24, boxShadow: '0 2px 16px rgba(0,0,0,0.18)' }
                        } >
                        <
                        h3 style = {
                            { textAlign: 'center', color: '#FFF', marginBottom: 16 }
                        } > Consumo por Tipo de Dispositivo(Fictício) < /h3> <
                        Doughnut data = {
                            {
                                labels: ['Sala', 'Câmera'],
                                datasets: [{
