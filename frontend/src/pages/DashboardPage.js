          ...
          <div className="energy-control-section">
            ...
            <div className="bottom-sections-grid">
              <div className="bottom-card">
                ...
                {/ * Dropdown para selecionar Timer 1 - 4 * /}{" "}
                <div style={{ width: "100%", marginBottom: 16 }}>
                  ...
                  <div
                    className={`menu-box-dropdown${true ? " open" : ""}`}
                    tabIndex={0}
                  >
                    <button
                      type="button"
                      className={`menu-box-dropdown-btn selected`}
                      style={{ width: "100%" }}
                    >
                      {" "}
                    ...
                    <div
                      className="menu-box-dropdown-list"
                      style={{
                        display: "block",
                        position: "absolute",
                        zIndex: 10,
                ...
                {/ * Formulário do timer selecionado * /}{" "}
                <form
                  style={{
                    display: "flex",
                    flexDirection: "column",
