                ...
                {activeSection === 'inicio' && (
                    <>
                      ...
                      <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4, whiteSpace: 'nowrap' }}>
                        <span style={{ display: 'inline-block', width: 12, height: 12, borderRadius: 6, background: data.datasets[0].backgroundColor[0], marginRight: 4 }}></span>
                        <span style={{ color: '#FFF', fontWeight: 500 }}>Sala:</span>
                        <span style={{ color: '#FFF', fontWeight: 700 }}>{percentSala}%</span>
                      </span>
                      <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4, whiteSpace: 'nowrap' }}>
                        <span style={{ display: 'inline-block', width: 12, height: 12, borderRadius: 6, background: data.datasets[0].backgroundColor[1], marginRight: 4 }}></span>
