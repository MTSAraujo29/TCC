                ...
                {activeSection === 'controle' && (
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <label style={{ color: '#fff', fontWeight: 500, marginBottom: 2 }}>
                                    Dispositivo:
                                    <select
                                ...
                                {scheduleMessage && (
                                    <span
                                        style={{ color: scheduleMessageColor, fontSize: 14, marginTop: 4 }}
                                    >
                  {scheduleMessage}
                </span>
                                )}
                        ...
                        {/* Novo Card de Agendamentos à direita */}
                        <div
                            className="user-schedules-card"
                            style={{
                                flex: 1,
                                minWidth: 320,
                                maxWidth: 400,
                                    ...
                                    <ul style={{ listStyle: 'none', padding: 0, margin: 0, width: '100%' }}>
                                        {userSchedules.map(sch => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div>
                                                        <span style={{ fontWeight: 600 }}>{sch.deviceName}</span>{' '}
                                                        <span style={{ color: '#00e6fb', fontWeight: 500 }}>
                            {sch.time}
                          </span>{' '}
