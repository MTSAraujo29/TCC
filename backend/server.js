...
// <<< LINHA REMOVIDA AQUI: A rota `app.get('/')` que enviava a mensagem de texto foi REMOVIDA.
// <<< Não deve haver nenhuma `app.get('/')` antes da seção de servir arquivos estáticos.
